...
<body class="polka-dot">
    ...
    <section>
        <div class="jumbotron mt-5"
            ...
            <div class="container">
                <h1 class="cursive mb-5">Add a New Product</h1>
            </div>
        </div>
    </section>
    <div class="container w-100 h-50 form-container">
            ...
            <form:form method="POST" action="/addProduct" modelAttribute="product" enctype='multipart/form-data'>
                <table>
                    ...
                    <tr>
                        ...
                        <td><form:textarea path="description" rows="2" required="required"/></td>
                    ...
                    <tr>
                        ...
                        <td><form:input path="unitPrice" required="required" type="number" min="0"/></td>
                        <td><form:errors path="unitPrice" cssClass="error"/></td>
                    </tr>
                    <tr>
                        <td><form:label path="unitsInStock">In stock</form:label></td>
                        <td><form:input path="unitsInStock" required="required" type="number" min="0"/></td>
